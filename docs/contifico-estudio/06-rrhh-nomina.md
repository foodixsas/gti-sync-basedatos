...
## 5. Cómo se accede
Solo web. Listas con filtros: `rrhh/periodos/?fecha_inicio=&fecha_fin=&tipo_rol=RPM|RPQ&estado=-1|C|G` (usar **RPQ** para FOODIX), `rrhh/movimientos/consultar_movimientos/?anio=&mes=`, `rrhh/prestamos/?tipo_configuracion=RPM&estado=`; exports `excel`/`pdf`. API v1 `rrhh/rol-pago/` a probar.

## 6. Uso real en FOODIX
- **Contífico generó la nómina quincenal de FOODIX hasta la PRIMERA quincena de julio 2026**: 48 períodos RPQ en 2025–2026, todos GENERADA (ej. 2ª quincena junio 2026: ingresos $40,720, egresos $20,265, neto $20,455; 1ª quincena julio: $13,577). Último pago registrado en `rrhh/movimientos/`: 15/07/2026 ("PRIMERA - Julio, 2026", transferencia/ND, comprobante 202607000139); **agosto y septiembre: 0 pagos**. Préstamos quirografarios cargados el 16/07/2026 (25 filas, estado PENDIENTE). Asientos con glosa de nómina: 2021 37 · 2022 115 · 2023 198 · 2024 193 · 2025 602 · 2026 1,916 (uno por empleado y período: "Registro de sueldos y provisión de beneficios sociales <mes>, - <nombre>", "Cancelación de haberes…").
- **Desde agosto 2026 la nómina se hace en la app propia** (`gth_nom_periodos`: 9 períodos creados entre el 26-ago y el 02-sep). **Asientos de nómina en Contífico por mes de 2026** (líneas con glosa de sueldos/haberes, `evidencia/fase2b.txt`): ene 1,151 · feb 1,243 · mar 6,337 · abr 4,908 · may 3,264 · jun 9,327 · jul 1,429 · **ago 252 · sep 12**. Desde agosto la nómina de la app propia **no se está contabilizando en Contífico** (o solo liquidaciones sueltas). ⚠ Punto para Contabilidad: cómo entra el rol de agosto y septiembre al libro.
- 104 personas con rol empleado en Contífico.
